...
// TransferTxParams contains all the input parameters for a transaction
...
// It creates a transfer record, add account entries, and updates account
// balance within a single transaction
func (store *SQLStore) TransferTx(ctx context.Context, arg TransferTxParams) (TransferTxResults, error) {
	...
	err := store.execTx(ctx, func(q *Queries) error {
		...
		// // acct1, err := q.GetAccountForUpdate(ctx, arg.FromAccountID)
		// // if err != nil {
		// // 	return err
		// // }
		...
		// // acct2, err := q.GetAccountForUpdate(ctx, arg.ToAccountID)
		// // if err != nil {
		// // 	return err
		// // }
